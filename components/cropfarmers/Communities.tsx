...
const communitiesData: Community[] = [
  {
    ...
    description: 'A community for farmers interested in organic farming methods.',
    membersCount: 125,
  },
  {
    id: '2',
    name: 'Sustainable Maize Farmers',
    description: 'Discuss sustainable farming practices for maize cultivation.',
    membersCount: 98,
  },
  {
    id: '3',
    name: 'Vegetable Growers Network',
    description: 'Connect with other vegetable farmers to share insights and tips.',
    membersCount: 150,
  },
  {
    id: '4',
    name: 'Drought-Resistant Crop Farmers',
    description: 'Join the community focused on growing crops in dry climates.',
    membersCount: 80,
  },
];
